...
<head>
  ...
  <title>Muscle Monster Gym</title>
...
<body onload="getDate()">
  ...
  $server = "localhost";
  $username = "id21655566_gym";
  $password= "rtnb8815:NR";
  ...
  $sql = "INSERT INTO `id21655566_gym`.`exercise` (`userId`, `description`, `duration`, `date`) VALUES ('$userId', '$description', '$duration', '$date');";
